...
, function() {
	...
	document.body.style.backgroundImage = 'url(images/pattern3.jpg)';
    notes1 = {
        "1C": new Howl({
            urls: [ "sounds/3C.mp3" ]
        }),
    ...
    $(".piano").bind("selectstart dragstart", 
    function(ev) {
        return ev.preventDefault(), !1;
    }), $(window).bind("keydown keyup", 
    function(ev) {
        var keyNo = ev.which, $key = $('[keycode="' + keyNo + '"]'), note = $key.attr("note");
        note && ("keydown" == ev.type ? lockEvent[keyNo] || (notes1[note].play(), lockEvent[keyNo] = !0, 
    ...
    function() {
        var me = $(this), noteClick = me.attr("note");
        notes1[noteClick].play();
    });
}();
